...
module TransfersHelper
  ...
  #  - minimum_pick:     The minimum pick volume possible for both the sample
  #                      and the buffer. Units should match the target_volume.
  #
  # Returns:
  #  - A hash containing keys :sample_volume and :buffer_volume for the transfer.
