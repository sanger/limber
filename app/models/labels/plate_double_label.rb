...
class Labels::PlateDoubleLabel < Labels::Base
  def attributes
    { right_text: workline_identifier, left_text: labware.barcode.human, barcode: labware.barcode.machine }
  end

  def extra_attributes
    { right_text: "#{workline_identifier} #{labware.role} #{labware.purpose_name}", left_text: date_today }
  end
  ...
  def sprint_attributes
    {
      ...
      extra_right_text: "#{workline_identifier} #{labware.role} #{labware.purpose_name}",
