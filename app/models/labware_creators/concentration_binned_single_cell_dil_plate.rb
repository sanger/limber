...
module LabwareCreators
  ...
  #
  # This variation of the labware creator is used for creation of the scRNA cDNA Dil plate.
  #
  # Eg.
  # source_volume: 10,
  # diluent_volume: 25,
  ...
  class ConcentrationBinnedSingleCellDilPlate < PartialStampedPlate
    ...
    def well_filter
      @well_filter ||= WellFilterAllowingPartials.new(creator: self, request_state: 'started')
    end
  end
end
