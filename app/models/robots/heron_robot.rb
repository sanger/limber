...
module Robots
  # Specific to Heron pipeline, sitting between 'LHR RT Cherrypick' plate and 'LHR XP' plate
  ...
  # PCR plates are made from LHR RT Cherrypick, but not tracked in LIMS, just have barcodes printed
  # Barcodes consist of LHR RT Cherrypick plate barcode followed by a suffix of -PP1 or -PP2
