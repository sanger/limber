...
import { checkDuplicates, checkSize } from '@/javascript/shared/components/plateScanValidators'
import devourApi from '@/javascript/shared/devourApi'
import buildPlateObjs from '@/javascript/shared/plateHelpers'
import { handleFailedRequest, requestIsActive, requestsFromPlates } from '@/javascript/shared/requestHelpers'
import resources from '@/javascript/shared/resources'
import { baseTransferCreator } from '@/javascript/shared/transfersCreators'
import { transfersFromRequests } from '@/javascript/shared/transfersLayouts'
