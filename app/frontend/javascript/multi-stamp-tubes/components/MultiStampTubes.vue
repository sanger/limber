...
import { checkDuplicates, checkState } from '@/javascript/shared/components/tubeScanValidators'
...
import { transferTubesCreator } from '@/javascript/shared/transfersCreators'
import { transfersForTubes } from '@/javascript/shared/transfersLayouts'
import { buildTubeObjs } from '@/javascript/shared/tubeHelpers'
import { findUniqueIndex, indexToName } from '@/javascript/shared/wellHelpers'
