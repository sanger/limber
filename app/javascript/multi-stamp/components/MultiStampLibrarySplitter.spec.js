    ...
    describe('with several input plates', () => {
      it('sends a post request when the button is clicked', async () => {
        ...
        const plate2Content = {
          uuid: 'plate2-uuid',
          wells: [
            { uuid: 'well2-1', position: { name: 'A1' }, aliquots: [{}], requests_as_source: [ 
              { uuid: 'outer2-1', library_type: 'Lib A' },
              { uuid: 'outer2-2', library_type: 'Lib B' }
            ] },
            { uuid: 'well2-2', position: { name: 'B2' }, aliquots: [{}], requests_as_source: [ 
              { uuid: 'outer2-3', library_type: 'Lib A' },
              { uuid: 'outer2-4', library_type: 'Lib B' }
            ] },
            { uuid: 'well2-3', position: { name: 'A3' }, aliquots: [{}], requests_as_source: [ 
        ...
        const plate4Content = {
          uuid: 'plate4-uuid',
          wells: [
            { uuid: 'well4-3', position: { name: 'H3' }, aliquots: [{}], requests_as_source: [ 
