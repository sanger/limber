...
{include:LabwareCreators::Uncreatable}
  ...
  CLCM Stock, LCA Blood Vac, LDW-96 Stock, LILYS-96 Stock, LRC Blood Vac, LRC HT 5p cDNA Input, LRC PBMC Pools Input, LTHR Cherrypick, LTHR RT, and LTHR-384 RT
...
{include:LabwareCreators::TenStamp}
  ...
  Used directly in 4 purposes:
  LBC Aggregate, LBC Cherrypick, LRC HT 5p Aggregate, and LRC HT 5p Cherrypick
