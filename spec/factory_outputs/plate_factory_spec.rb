    ...
    %(
    {
      "plate": {
        ...
        "comments": {
          "size": 3,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/comments"
          }
        },
        "wells": {
          "size": 30,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/wells"
          }
        },
        "submission_pools": {
          "size": 2,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/submission_pools"
          }
        },
        "requests": {
          "size": 0,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/requests"
          }
        },
        "qc_files": {
          "size": 0,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/qc_files"
          }
        },
        "source_transfers": {
          "size": 0,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/source_transfers"
          }
        },
        "transfers_to_tubes": {
          "size": 0,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/transfers_to_tubes"
          }
        },
        "creation_transfers": {
          "size": 0,
          "actions": {
            "read": "http://example.com:300/example-plate-uuid/creation_transfers"
          }
        },
        "plate_purpose": {
          "actions": {
        ...
        "actions": {
          "read": "http://example.com:300/example-plate-uuid"
        },
        "uuid": "example-plate-uuid",
        "name": "Cherrypicked 427444",
        "qc_state": null,
