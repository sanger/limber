  ...
  describe 'CREATE' do
    ...
    has_a_working_api
      ...
      it 'creates print_job' do
        ...
        PMB::TestSuiteStubs.post('/v1/print_jobs', print_job_post('tube_printer', label_template_id)) { |env| [200, {content_type:'application/json' }, print_job_response('tube_printer', label_template_id)]}

        request.env['HTTP_REFERER'] = root_path
        expected_labels = [{"label" => {"test_attr" => "test","barcode"=>"12345"}}]
        post :create, params: {print_job: {printer_name: "tube_printer", printer_type: "tube",
