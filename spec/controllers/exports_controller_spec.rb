...
RSpec.describe ExportsController, type: :controller do
  ...
  context 'on generating a csv' do
    ...
    context 'where template is for the hamilton robot' do
      ...
      context 'where csv id requested is hamilton_lrc_ht_5p_cherrypick_to_lrc_ht_5p_gex_dil.csv' do
        let(:csv_id) { 'hamilton_lrc_ht_5p_cherrypick_to_lrc_ht_5p_gex_dil' }
