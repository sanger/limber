...
RSpec.describe 'exports/hamilton_lbc_bcr_enrich2_2xspri_to_lbc_bcr_dil_2.csv.erb' do
  context 'with a full plate' do
    ...
    before do
      create(:concentration_normalisation_purpose_config, uuid: dest_labware.purpose.uuid)
    ...
    let(:expected_content) do
      [
        ...
        %w[DN1S A1 DN2T A1 2.0 18.0],
        %w[DN1S B1 DN2T B1 2.0 18.0]
      ]
    end
