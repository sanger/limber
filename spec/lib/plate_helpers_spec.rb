...
describe PlateHelper do
  ...
  let(:pool)  { { "pool1"=>{"wells"=>["C3", "D1", "D2", "D3", "E1", "E2", "E3", "F1", "F2", "F3", "G1", "G2", "G3", "H1", "H2", "H3", "A1", "A2", "A3", "B1", "B2", "B3", "C1", "C2"]},
                  "pool2"=>{"wells"=>["E7", "F6", "G6", "H6", "A7", "B7", "C7", "D7", "E6"]},
                  "pool3"=>{"wells"=>["C6", "D4", "D5", "D6", "E4", "E5", "F4", "F5", "G4", "A4", "A5", "A6", "B4", "B5", "B6", "C4", "C5", "G5", "H4", "H5"]}, 
              } }
