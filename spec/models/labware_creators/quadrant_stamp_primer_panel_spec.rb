    ...
    let(:form_attributes) do
      {
        ...
        purpose_uuid: child_purpose_uuid,
        transfers: [
          { source_plate: parent1_uuid, source_asset: '3-well-A1', outer_request: 'request-0', new_target: { location: 'A1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-B1', outer_request: 'request-1', new_target: { location: 'C1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-C1', outer_request: 'request-2', new_target: { location: 'E1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-D1', outer_request: 'request-3', new_target: { location: 'G1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-E1', outer_request: 'request-4', new_target: { location: 'I1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-F1', outer_request: 'request-5', new_target: { location: 'K1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-G1', outer_request: 'request-6', new_target: { location: 'M1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-H1', outer_request: 'request-7', new_target: { location: 'O1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-A2', outer_request: 'request-8', new_target: { location: 'A3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-B2', outer_request: 'request-9', new_target: { location: 'C3' } },
          { source_plate: parent2_uuid, source_asset: '4-well-A1', outer_request: 'request-0', new_target: { location: 'B1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-B1', outer_request: 'request-1', new_target: { location: 'D1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-C1', outer_request: 'request-2', new_target: { location: 'F1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-D1', outer_request: 'request-3', new_target: { location: 'H1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-E1', outer_request: 'request-4', new_target: { location: 'J1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-F1', outer_request: 'request-5', new_target: { location: 'L1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-G1', outer_request: 'request-6', new_target: { location: 'N1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-H1', outer_request: 'request-7', new_target: { location: 'P1' } },
          { source_plate: parent2_uuid, source_asset: '4-well-A2', outer_request: 'request-8', new_target: { location: 'B3' } },
          { source_plate: parent2_uuid, source_asset: '4-well-B2', outer_request: 'request-9', new_target: { location: 'D3' } }
        ]
      }
    end
