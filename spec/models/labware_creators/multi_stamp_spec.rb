...
RSpec.describe LabwareCreators::MultiStamp do
  ...
  context 'on new' do
    ...
    subject do
      LabwareCreators::MultiStamp.new(api, form_attributes)
    end
  ...
  context 'on create' do
    subject do
      LabwareCreators::MultiStamp.new(api, form_attributes.merge(user_uuid: user_uuid))
    end
    ...
    let(:form_attributes) do
      {
        ...
        transfers: [
          # from parent 1
          { source_plate: parent1_uuid, source_asset: '3-well-A1', outer_request: 'request-p1-1',
            new_target: { location: 'A1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-B1', outer_request: 'request-p1-2',
            new_target: { location: 'B1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-C1', outer_request: 'request-p1-3',
            new_target: { location: 'C1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-D1', outer_request: 'request-p1-4',
            new_target: { location: 'D1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-E1', outer_request: 'request-p1-5',
            new_target: { location: 'E1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-F1', outer_request: 'request-p1-6',
            new_target: { location: 'F1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-G1', outer_request: 'request-p1-7',
            new_target: { location: 'G1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-H1', outer_request: 'request-p1-8',
            new_target: { location: 'H1' } },
          { source_plate: parent1_uuid, source_asset: '3-well-A2', outer_request: 'request-p1-9',
            new_target: { location: 'A2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-B2', outer_request: 'request-p1-10',
            new_target: { location: 'B2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-C2', outer_request: 'request-p1-11',
            new_target: { location: 'C2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-D2', outer_request: 'request-p1-12',
            new_target: { location: 'D2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-E2', outer_request: 'request-p1-13',
            new_target: { location: 'E2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-F2', outer_request: 'request-p1-14',
            new_target: { location: 'F2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-G2', outer_request: 'request-p1-15',
            new_target: { location: 'G2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-H2', outer_request: 'request-p1-16',
            new_target: { location: 'H2' } },
          { source_plate: parent1_uuid, source_asset: '3-well-A3', outer_request: 'request-p1-17',
            new_target: { location: 'A3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-B3', outer_request: 'request-p1-18',
            new_target: { location: 'B3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-C3', outer_request: 'request-p1-19',
            new_target: { location: 'C3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-D3', outer_request: 'request-p1-20',
            new_target: { location: 'D3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-E3', outer_request: 'request-p1-21',
            new_target: { location: 'E3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-F3', outer_request: 'request-p1-22',
            new_target: { location: 'F3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-G3', outer_request: 'request-p1-23',
            new_target: { location: 'G3' } },
          { source_plate: parent1_uuid, source_asset: '3-well-H3', outer_request: 'request-p1-24',
            new_target: { location: 'H3' } },

          # from parent 2
          { source_plate: parent2_uuid, source_asset: '4-well-A1', outer_request: 'request-p2-1',
            new_target: { location: 'A4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-B1', outer_request: 'request-p2-2',
            new_target: { location: 'B4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-C1', outer_request: 'request-p2-3',
            new_target: { location: 'C4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-D1', outer_request: 'request-p2-4',
            new_target: { location: 'D4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-E1', outer_request: 'request-p2-5',
            new_target: { location: 'E4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-F1', outer_request: 'request-p2-6',
            new_target: { location: 'F4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-G1', outer_request: 'request-p2-7',
            new_target: { location: 'G4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-H1', outer_request: 'request-p2-8',
            new_target: { location: 'H4' } },
          { source_plate: parent2_uuid, source_asset: '4-well-A2', outer_request: 'request-p2-9',
            new_target: { location: 'A5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-B2', outer_request: 'request-p2-10',
            new_target: { location: 'B5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-C2', outer_request: 'request-p2-11',
            new_target: { location: 'C5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-D2', outer_request: 'request-p2-12',
            new_target: { location: 'D5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-E2', outer_request: 'request-p2-13',
            new_target: { location: 'E5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-F2', outer_request: 'request-p2-14',
            new_target: { location: 'F5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-G2', outer_request: 'request-p2-15',
            new_target: { location: 'G5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-H2', outer_request: 'request-p2-16',
            new_target: { location: 'H5' } },
          { source_plate: parent2_uuid, source_asset: '4-well-A3', outer_request: 'request-p2-17',
            new_target: { location: 'A6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-B3', outer_request: 'request-p2-18',
            new_target: { location: 'B6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-C3', outer_request: 'request-p2-19',
            new_target: { location: 'C6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-D3', outer_request: 'request-p2-20',
            new_target: { location: 'D6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-E3', outer_request: 'request-p2-21',
            new_target: { location: 'E6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-F3', outer_request: 'request-p2-22',
            new_target: { location: 'F6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-G3', outer_request: 'request-p2-23',
            new_target: { location: 'G6' } },
          { source_plate: parent2_uuid, source_asset: '4-well-H3', outer_request: 'request-p2-24',
            new_target: { location: 'H6' } }
        ]
      }
    end
