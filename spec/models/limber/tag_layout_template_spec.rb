...
RSpec.describe Limber::TagLayoutTemplate, tag_plate: true do
  ...
  context 'combinatorial by row' do
    ...
    let(:expected_layout) do
      {
        'A1' => [1, 1], 'A2' => [1, 1], 'A3' => [1, 1], 'A4' => [1, 1], 'A5' => [1, 1], 'A6' => [1, 1], 'A7' => [2, 1], 'A8' => [2, 1], 'A9' => [2, 1], 'A10' => [2, 1], 'A11' => [2, 1], 'A12' => [2, 1],
        'B1' => [1, 2], 'B2' => [1, 2], 'B3' => [1, 2], 'B4' => [1, 2], 'B5' => [1, 2], 'B6' => [1, 2], 'B7' => [2, 2], 'B8' => [2, 2], 'B9' => [2, 2], 'B10' => [2, 2], 'B11' => [2, 2], 'B12' => [2, 2],
        'C1' => [1, 3], 'C2' => [1, 3], 'C3' => [1, 3], 'C4' => [1, 3], 'C5' => [1, 3], 'C6' => [1, 3], 'C7' => [2, 3], 'C8' => [2, 3], 'C9' => [2, 3], 'C10' => [2, 3], 'C11' => [2, 3], 'C12' => [2, 3],
        'D1' => [1, 4], 'D2' => [1, 4], 'D3' => [1, 4], 'D4' => [1, 4], 'D5' => [1, 4], 'D6' => [1, 4], 'D7' => [2, 4], 'D8' => [2, 4], 'D9' => [2, 4], 'D10' => [2, 4], 'D11' => [2, 4], 'D12' => [2, 4],
        'E1' => [1, 5], 'E2' => [1, 5], 'E3' => [1, 5], 'E4' => [1, 5], 'E5' => [1, 5], 'E6' => [1, 5], 'E7' => [2, 5], 'E8' => [2, 5], 'E9' => [2, 5], 'E10' => [2, 5], 'E11' => [2, 5], 'E12' => [2, 5],
        'F1' => [1, 6], 'F2' => [1, 6], 'F3' => [1, 6], 'F4' => [1, 6], 'F5' => [1, 6], 'F6' => [1, 6], 'F7' => [2, 6], 'F8' => [2, 6], 'F9' => [2, 6], 'F10' => [2, 6], 'F11' => [2, 6], 'F12' => [2, 6],
        'G1' => [1, 7], 'G2' => [1, 7], 'G3' => [1, 7], 'G4' => [1, 7], 'G5' => [1, 7], 'G6' => [1, 7], 'G7' => [2, 7], 'G8' => [2, 7], 'G9' => [2, 7], 'G10' => [2, 7], 'G11' => [2, 7], 'G12' => [2, 7],
        'H1' => [1, 8], 'H2' => [1, 8], 'H3' => [1, 8], 'H4' => [1, 8], 'H5' => [1, 8], 'H6' => [1, 8], 'H7' => [2, 8], 'H8' => [2, 8], 'H9' => [2, 8], 'H10' => [2, 8], 'H11' => [2, 8], 'H12' => [2, 8]
      }
    end
    it_behaves_like 'a tag layout'
  end
