...
ROBOT_CONFIG =
  RobotConfiguration::Register.configure do
    ...
    # For scRNA Core pipeline LRC GEM-X 5p cDNA Input to Cherrypick
    custom_robot(
      ...
      beds: {
        bed(1).barcode => {
          ...
          states: %w[pending passed qc_complete],
          child: bed(13).barcode,
          label: 'Bed 1'
        },
        bed(2).barcode => {
    ...
    # For scRNA Core pipeline LRC GEM-X 5p cDNA PCR XP to Cherrypick
    custom_robot(
