...
ROBOT_CONFIG = RobotConfiguration::Register.configure do
  ...
  custom_robot('nx-96-post-shear-to-post-shear-xp', name: 'nx-96 Post-Shear => Post-Shear XP',
                                                    layout: 'bed',
                                                    beds: {
  ...
  custom_robot('nx-96-lib-pcr-to-lib-pcr-xp', name: 'Lib PCR => Lib PCR XP',
                                              layout: 'bed',
                                              beds: {
  ...
  custom_robot('nx-8-lib-pcr-xp-to-isch-lib-pool', name: 'nx-8 Lib PCR-XP => Limber Lib Pool',
                                                   layout: 'bed',
                                                   beds: {
